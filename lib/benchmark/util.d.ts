...
export declare type BenchmarkFunction = (
  description: Description,
  cycleFn: CycleFunction,
) => void;
export declare type GroupFunction = (done: DoneFunction) => void;
export declare type AfterEachCallbackFunction = (
  descr: Description,
  event: any,
) => void;
export declare type AfterEachFunction = (
  afterEachFnArg: AfterEachCallbackFunction,
) => void;
export declare type AfterAllCallbackFunction = () => void;
export declare type AfterAllFunction = (
  afterAllFn: AfterAllCallbackFunction,
) => void;
