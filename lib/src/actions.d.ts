...
export declare function isQueryResultAction(
  action: ApolloAction,
...
export declare function isQueryErrorAction(
  action: ApolloAction,
...
export declare function isQueryInitAction(
  action: ApolloAction,
...
export declare function isQueryResultClientAction(
  action: ApolloAction,
...
export declare function isQueryStopAction(
  action: ApolloAction,
...
export declare function isMutationInitAction(
  action: ApolloAction,
...
export declare function isMutationResultAction(
  action: ApolloAction,
...
export declare function isMutationErrorAction(
  action: ApolloAction,
...
export declare function isUpdateQueryResultAction(
  action: ApolloAction,
...
export declare function isStoreResetAction(
  action: ApolloAction,
...
export declare function isSubscriptionResultAction(
  action: ApolloAction,
...
export declare function isWriteAction(
  action: ApolloAction,
): action is WriteAction;
export declare type ApolloAction =
  | QueryResultAction
  | QueryErrorAction
  | QueryInitAction
