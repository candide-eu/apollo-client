...
describe('network interface', function () {
    ...
    describe('middleware', function () {
        ...
        it('should cause the parent request to fail', function () {
            var testWare1 = TestErrorWare([]);
            var swapi = createNetworkInterface({
                uri: 'http://graphql-swapi.test/',
            });
            swapi.use([testWare1]);
            ...
            return swapi.query(simpleRequest).catch(function (data) {
    ...
    describe('making a request', function () {
        ...
        it('should throw an error with the response body when request is forbidden', function () {
            var unauthorizedUrlWithBody = 'http://unauthorized.test.with.body/';
...
function TestErrorWare(options) {
    if (options === void 0) { options = []; }
    return {
        applyMiddleware: function (request, next) {
